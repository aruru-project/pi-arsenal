...
MODIFICATION NOTICE: Adapted from OpenAI Codex's imagegen skill for the global
Pi azure-imagegen skill. The API/CLI fallback wording and repo-specific package
guidance were removed; the alpha-matting behavior remains compatible.
Licensed under Apache-2.0; see ../LICENSE.txt and ../NOTICE.md.
"""
...
def _dependency_hint(package: str) -> str:
    return (
        f"Install {package} in the active Python environment, for example with "
